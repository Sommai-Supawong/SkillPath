...
class Skill(Base, TimestampMixin):
    ...
    skill_type: Mapped[str] = mapped_column(String(80), default="Tool", server_default="Tool", index=True)
    icon_key: Mapped[str | None] = mapped_column(String(80), nullable=True)
    icon_kind: Mapped[str | None] = mapped_column(String(20), nullable=True)
